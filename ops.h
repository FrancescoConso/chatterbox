...
typedef enum {
    ...
    //  la gestione dei gruppi e' opzionale //decommentato per problemi di compilazione
    ...
    OP_MAX_CONNECTIONS = 30,	//sono già connessi troppi utenti
	OP_FILE_TOOLONG = 31,		//dimensione file troppo grande
